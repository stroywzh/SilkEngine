...
public static class Log
{
    ...
    public static void AddWriter(ILogWriter writer) { lock (_lock) _writers.Add(writer); }
    public static void RemoveWriter(ILogWriter writer) { lock (_lock) _writers.Remove(writer); }
