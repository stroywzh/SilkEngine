...
public class MouseState
{
    ...
    private readonly bool[] _prevBtns = new bool[3], _currBtns = new bool[3];
    ...
    public void SwapBuffers() { _prevPos = _pos; Array.Copy(_currBtns, _prevBtns, 3); ScrollDelta = 0; }
    public void SetPosition(Vector2 p) => _pos = p;
    public void SetButton(int btn, bool pressed) { if (btn < 3) _currBtns[btn] = pressed; }
}
