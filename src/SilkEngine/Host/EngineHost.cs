...
public sealed class EngineHost : IDisposable
{
    ...
    /// <summary>
    /// 内部心跳驱动器（过渡期公开；业务应优先使用 <see cref="SceneManager"/>/
    /// <see cref="AssetManager"/> 门面，后续版本将降为 internal）。
    /// </summary>
    public EngineLoop Loop => _loop ?? throw new InvalidOperationException("EngineHost.Initialize 尚未执行");
