...
{
    private HashSet<KeyCode> _prev = new(), _curr = new();
    ...
    public void SwapBuffers() { _prev = _curr; _curr = new HashSet<KeyCode>(); }
    public void SetKey(KeyCode key, bool pressed) { if (pressed) _curr.Add(key); }
}
