...
public class SilkInputProvider : IInputProvider
{
    ...
    private static Key Map(KeyCode kc) => kc switch
    {
        ...
        KeyCode.D0 => Key.Number0, KeyCode.D1 => Key.Number1, KeyCode.D2 => Key.Number2,
        KeyCode.D3 => Key.Number3, KeyCode.D4 => Key.Number4, KeyCode.D5 => Key.Number5,
        KeyCode.D6 => Key.Number6, KeyCode.D7 => Key.Number7, KeyCode.D8 => Key.Number8,
        ...
        KeyCode.LeftShift => Key.ShiftLeft, KeyCode.RightShift => Key.ShiftRight,
        KeyCode.LeftControl => Key.ControlLeft, KeyCode.RightControl => Key.ControlRight,
        KeyCode.LeftArrow => Key.Left, KeyCode.RightArrow => Key.Right,
        KeyCode.UpArrow => Key.Up, KeyCode.DownArrow => Key.Down,
