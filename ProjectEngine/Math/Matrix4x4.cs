...
public struct Matrix4x4 : IEquatable<Matrix4x4>
{
    ...
    public static Matrix4x4 CreateTranslation(Vector3 pos) =>
        new() { M11 = 1, M22 = 1, M33 = 1, M44 = 1, M14 = pos.X, M24 = pos.Y, M34 = pos.Z };

    public static Matrix4x4 CreateScale(Vector3 scale) =>
        new() { M11 = scale.X, M22 = scale.Y, M33 = scale.Z, M44 = 1 };
    ...
    public static Matrix4x4 CreatePerspectiveFieldOfView(float fov, float aspect, float near, float far)
    {
        ...
        {
            M11 = f / aspect, M22 = f,
            M33 = far / (far - near), M34 = 1f,
            M43 = -near * far / (far - near), M44 = 1f
        };
    }
